...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    #please read the comments I have left, once you are fine with the changes I made,
    #I will delete the unnecessary comments and submit our project for phase 1
    ...
    while score0 < goal and score1<goal: 
        ...
        if who == 0:
            ...
            while more_boar(score0,score1) == True and score0<goal:
                score0+=take_turn(strategy0(score0, score1), score1, dice) 
                say = say(score0, score1)
            who = next_player(who)
            ...
            while more_boar(score1,score0) == True and score1<goal:
                score1+=take_turn(strategy1(score1, score0), score0, dice)   
                say = say(score0, score1)
...
def more_boar_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    if piggypoints_strategy(score, opponent_score,cutoff,num_rolls) == 0 or more_boar(score+piggy_points(opponent_score), opponent_score):
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    # BEGIN PROBLEM 12
    return 6
    #if more_boar_strategy(score, opponent_score,cutoff,num_rolls) == 0
    # END PROBLEM 12
